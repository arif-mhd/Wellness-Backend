              ...
              <div className="flex flex-wrap items-center gap-2.5">
                ...
                <div className="relative flex items-center">
                  ...
                  <input
                    ...
                    className="border border-slate-200 bg-white rounded-full pl-9 pr-4 py-2 text-[13px] font-medium text-slate-700 outline-none focus:ring-2 focus:ring-blue-500/20 w-44 shadow-sm transition-all"
                  />
                  {searchQuery && (
                    <button
