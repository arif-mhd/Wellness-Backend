    ...
    case 'heading':
      return (
        <input
          ...
          className="text-[18px] font-black text-slate-800 bg-transparent border-b-2 border-[#6A8BFF]/30 focus:outline-none focus:border-[#6A8BFF] w-full pb-1 transition"
    ...
    <ProtectedRoute>
      <div className="w-full pb-12 font-sans animate-in fade-in duration-300 flex flex-col">
        ...
        <div className="flex items-center gap-4 mb-8">
          ...
          <input value={formTitle} onChange={e => setFormTitle(e.target.value)} placeholder="Untitled Form" className="text-[24px] font-black text-[#1e293b] tracking-tight bg-transparent focus:outline-none border-b-2 border-transparent focus:border-[#6A8BFF]/30 transition" />
        </div>
        ...
        <div className="flex gap-7 items-start min-h-[800px]">
          ...
          <div className="flex-1 bg-white rounded-[2rem] p-8 shadow-sm border border-slate-50 flex flex-col min-h-[800px]">
            <div className="mb-8">
              <input value={formTitle} onChange={e => setFormTitle(e.target.value)} placeholder="Form Title" className="w-full bg-[#f8fafd] border-none rounded-2xl px-6 py-4 text-[15px] font-bold text-slate-800 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-[#6A8BFF]/50 transition" />
            </div>
            ...
            {fields.length === 0 ? (
              <div className="flex-1 flex flex-col items-center justify-center gap-3 border-2 border-dashed border-slate-200 rounded-2xl text-slate-400">
                ...
                <span className="text-[13px] font-bold">Click any element on the left to add it here</span>
              </div>
            ) : (
                    ...
                    >
                      {field.type !== 'heading' && (
                        <div className="flex items-center gap-1.5 mb-2">
                          ...
                          />
                          {field.required && <span className="text-red-500 text-[11px] font-black">*</span>}
                        </div>
                      )}
