      ...
      <div className="flex-1 flex flex-col min-w-0 z-10 h-full">
        ...
        <header className={`h-[96px] flex items-center justify-between shrink-0 select-none transition-all duration-300 ${isVideoCall ? "px-10 lg:px-[40px]" : sidebarOpen ? "px-6 xl:px-[24px]" : "px-10 lg:px-[40px]"
          ...
          <div className="flex items-center gap-3">
            {/* SOS / Emergency Records Button */}
            <button
              onClick={() => router.push("/dashboard/sos")}
              className="h-[48px] bg-[#E84949] text-white px-[13px] rounded-xl text-[13px] font-medium flex items-center gap-2 shadow-[0_6px_20px_rgba(232,73,73,0.25)] hover:shadow-[0_8px_24px_rgba(232,73,73,0.35)] transition-all select-none"
            >
              ...
              <span>{pathname?.startsWith("/dashboard/profile") ? "Emergency Records" : "SOS Records"}</span>
            </button>
