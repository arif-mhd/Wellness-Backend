      ...
      <div className="flex-1 flex flex-col min-w-0 z-10 h-full">
        ...
        <header className={`h-[96px] flex items-center justify-between shrink-0 select-none transition-all duration-300 ${isVideoCall ? "px-10 lg:px-[40px]" : sidebarOpen ? "px-6 xl:px-[24px]" : "px-10 lg:px-[40px]"
          ...
          <div className="flex items-center gap-3">
            {/* SOS Records Button */}
            <button className="h-[48px] bg-gradient-to-b from-[#FF6B6B] to-[#E84949] hover:from-[#FF7A7A] hover:to-[#D63D3D] text-white px-5 rounded-xl text-[13px] font-medium flex items-center gap-2.5 shadow-[0_4px_10px_rgba(232,73,73,0.2)] transition-all active:scale-95 select-none">
