        ...
        <header className={`h-[96px] flex items-center justify-between shrink-0 select-none transition-all duration-300 ${
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className="relative h-[48px] w-[48px] sm:w-auto px-0 sm:px-5 bg-gradient-to-b from-[#8AA0FF] to-[#5476FC] text-white rounded-xl text-[13px] font-bold flex items-center justify-center sm:gap-2.5 shadow-[0_6px_20px_rgba(84,118,252,0.25)] hover:shadow-[0_8px_24px_rgba(84,118,252,0.35)] transition-all select-none shrink-0"
            >
