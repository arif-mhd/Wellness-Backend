...
export default function WaitingRoom({ onClose }: WaitingRoomProps) {
  ...
  return (
    <div className="w-full min-h-full bg-[#F7F9FC] font-outfit select-none flex flex-col p-4 md:p-6 lg:p-8 animate-fade-in relative">
      ...
      {/* Patient Profile Full-Screen Overlay inside Waiting Room */}
      {profilePatient && (
        <PatientProfileModal
      ...
      <div className="flex flex-col lg:flex-row gap-8 items-start w-full flex-1">
            ...
            <div className="flex flex-col gap-3">
              {onlinePatients.map((patient) => {
                ...
                return (
                  <div
                    key={patient.id}
                    className={`flex flex-col gap-4 p-4 rounded-[8px] border transition-all duration-200 ${
                      isSelected 
                  ...
                  >
                    ...
                    <div className="flex items-center gap-2 mt-1">
                      <button
                        ...
                        className={`flex-1 py-1.5 rounded-[12px] font-medium text-[13px] leading-5 border transition-all duration-200 ${
                          isSelected
            ...
            {MOCK_PAST_CONSULTATIONS.map((c, idx) => {
              ...
              return (
                <div
                  ...
                  className={`flex flex-col sm:flex-row sm:items-center justify-between gap-4 p-4 rounded-[12px] cursor-pointer transition-all duration-200 ${
                    isFirst ? "bg-[#EDF0FF]" : "bg-transparent hover:bg-gray-50"
                  }`}
                >
        ...
        <div className="w-full lg:w-[372px] shrink-0 bg-[#F5F6FA] border border-white rounded-[12px] p-6 flex flex-col gap-6">
          ...
          <button
            onClick={() => setProfilePatient(mapToPatient(selectedPatient))}
