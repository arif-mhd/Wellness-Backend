  ...
  return (
    <div className="flex h-screen bg-[#F7F9FC] overflow-hidden relative font-sans">
      ...
      <div className="flex-1 flex flex-col min-w-0 z-10 h-full">
        ...
        <header className="h-[96px] flex items-center justify-between px-8 shrink-0 select-none">
          {/* Logo Frame */}
          ...
          <div className="flex items-center gap-3">
            {/* SOS Records Button */}
            <button className="h-[48px] bg-[#E84949] text-white px-5 rounded-xl text-[13px] font-bold flex items-center gap-2.5 shadow-[0_6px_20px_rgba(232,73,73,0.25)] hover:shadow-[0_8px_24px_rgba(232,73,73,0.35)] transition-all select-none">
            ...
            <button className="h-[48px] bg-gradient-to-b from-[#8AA0FF] to-[#5476FC] text-white px-5 rounded-xl text-[13px] font-bold flex items-center gap-2.5 shadow-[0_6px_20px_rgba(84,118,252,0.25)] hover:shadow-[0_8px_24px_rgba(84,118,252,0.35)] transition-all select-none">
