...
const FEE_ROWS = [
  { city: "Abu Dhabi",      fee: "AED 200.00" },
  { city: "Dubai",          fee: "AED 200.00" },
  { city: "Sharjah",        fee: "AED 200.00" },
  { city: "Ajman",          fee: "AED 200.00" },
  { city: "Umm Al-Quwain",  fee: "AED 200.00" },
  { city: "Ras Al Khaimah", fee: "AED 200.00" },
  { city: "Fujairah",       fee: "AED 200.00" },
];

const DOCS = [
  { label: "Medical Degree Certificate",  file: "Med_certificate.pdf" },
  { label: "Specialization Certificates", file: "Spec_certificate.pdf" },
  { label: "Other Certificates",          file: "Certificate.pdf" },
];
    ...
    <>
      ...
      <div className="flex items-start gap-5">
        ...
        <div className="flex flex-col gap-2 justify-center">
          <h1 className="text-[#383F45] text-[32px] font-normal leading-none tracking-tight">Dr. Jordan Anderson</h1>
          <p className="text-xs tracking-tight">
            <span className="text-[#676E76]">LICENSE NUMBER </span>
            <span className="text-[#5476FC] font-bold">DHA-12345678</span>
          </p>
          <span 
      ...
      <section className="flex flex-col gap-4">
        ...
        <div className="flex gap-5">
          <InfoCard label="License Info" value="DHA-12345678" editable />
          <InfoCard label="Languages Known" value="English, Arabic" editable />
        ...
        <div className="flex gap-6">
          ...
          <div className="bg-white rounded-xl p-6 flex flex-col gap-5 flex-1">
            {[
              { label: "Date of Birth", value: "02 January 1990" },
              { label: "Blood Group",   value: "O +ve" },
              { label: "Height (cm)",   value: "176" },
              { label: "Weight (kg)",   value: "86" },
              { label: "Location",      value: "1234 Al Zahra Street, Postal Code: 12345" },
            ].map(({ label, value }) => (
              <div key={label} className="flex flex-col gap-1.5">
                <span className="text-[#676E76] text-xs">{label}</span>
                <span className="text-[#24292E] text-xs font-bold">{value}</span>
