...
export default function FeedbackPage() {
  ...
  const fetchReviews = useCallback(async () => {
    ...
    try {
      ...
      const res = await apiFetch("/api/feedback/pharmacy");
                            ...
                            <td className="py-4 pl-2">
                              ...
                              <div className="min-w-0">
                                <div className="flex items-center gap-2">
                                  ...
                                  {rev.rating <= 2 && (
                                    <span className="px-1.5 py-0.5 rounded text-[9px] font-bold bg-red-50 text-red-600 border border-red-100 uppercase tracking-wider">
                                      Needs Attention
                                    </span>
                                  )}
                                </div>
